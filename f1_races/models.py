...
class continents(models.Model):
    ...
    demonym = models.CharField(max_length=50, null=True, blank=True)  # Campo adicionado para demonym
...
class countries(models.Model):
    ...
    demonym = models.CharField(max_length=50, null=True, blank=True)
...
class constructors(models.Model):
    ...
    bestChampionshipPosition = models.IntegerField(null=True, blank=True)
    bestStartingGridPosition = models.IntegerField(null=True, blank=True)
    bestRaceResult = models.IntegerField(null=True, blank=True)
    totalChampionshipWins = models.IntegerField(null=True, blank=True)
    ...
    totalChampionshipPoints = models.FloatField(null=True, blank=True)
...
class grandPrix(models.Model):
    ...
    countriesID = models.ForeignKey(countries, related_name='grand_prix_countriesID', on_delete=models.CASCADE, null=True, blank=True)
    totalRacesHeld = models.IntegerField()
...
class drivers(models.Model):
    ...
    permanentNumber = models.IntegerField(null=True, blank=True)
    gender = models.CharField(max_length=10, blank=True)
    dateOfBirth = models.DateField(null=True, blank=True)
    dateOfDeath = models.DateField(null=True, blank=True)
    placeOfBirth = models.CharField(max_length=100, blank=True)
    countryOfBirthID = models.ForeignKey(countries, on_delete=models.CASCADE, related_name='drivers_country_of_birth', null=True, blank=True)
    nationalityCountryID = models.ForeignKey(countries, on_delete=models.CASCADE, related_name='drivers_nationality', null=True, blank=True)
...
class tyreManufacturers(models.Model):
    ...
    name = models.CharField(max_length=100)
    countriesID = models.ForeignKey(countries, related_name='tyre_manufacturers_countriesID', on_delete=models.CASCADE, null=True, blank=True)
    bestStartingGridPosition = models.IntegerField(null=True, blank=True)
    bestRaceResult = models.IntegerField(null=True, blank=True)
    totalRaceEntries = models.IntegerField(null=True, blank=True)
    totalRaceStarts = models.IntegerField(null=True, blank=True)
...
class races(models.Model):
    racesID = models.IntegerField(primary_key=True)
    year = models.ForeignKey(sessions, related_name='races_year', on_delete=models.CASCADE, null=True, blank=True)
    round = models.IntegerField(null=True, blank=True)
    date = models.DateField(null=True, blank=True)
    time = models.TimeField(null=True, blank=True)
    grandPrixID = models.ForeignKey(grandPrix, related_name='races_grandPrixID', on_delete=models.CASCADE, null=True, blank=True)
    officialName = models.CharField(max_length=100, blank=True)
    qualifyingFormat = models.CharField(max_length=100, blank=True)
    sprintQualifyingFormat = models.CharField(max_length=100, blank=True)
    circuitsID = models.ForeignKey(circuits, related_name='races_circuitsID', on_delete=models.CASCADE, null=True, blank=True)
    direction = models.CharField(max_length=100, blank=True)
    courseLength = models.FloatField(null=True, blank=True)
    turns = models.IntegerField(null=True, blank=True)
    laps = models.IntegerField(null=True, blank=True)
    distance = models.FloatField(null=True, blank=True)
    scheduledLaps = models.IntegerField(null=True, blank=True)
    scheduledDistance = models.FloatField(null=True, blank=True)
...
class races_sprint_starting_grid_positions(models.Model):
    ...
    qualificationPositionNumber = models.IntegerField(null=True, blank=True)
    qualificationPositionText = models.CharField(max_length=100, null=True, blank=True)
    gridPenalty = models.CharField(max_length=10, null=True, blank=True)
...
class sessions_entrants_drivers(models.Model):
    ...
    rounds = models.CharField(max_length=100, null=True, blank=True)
