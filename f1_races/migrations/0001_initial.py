# Generated by Django 5.2.3 on 2025-08-23 03:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('fullName', models.CharField(max_length=100)),
                ('constructorsID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.constructors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('continentID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.continents')),
            ],
        ),
        migrations.AddField(
            model_name='constructors',
            name='countriesID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.countries'),
        ),
        migrations.CreateModel(
            name='circuits',
            fields=[
                ...
                ('countriesID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.countries')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enginesManufacturersID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.enginesmanufacturers')),
            ],
            options={
                'verbose_name': 'Engine',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('circuitsID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.circuits')),
                ('grandPrixID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.grandprix')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.sessions')),
            ],
            options={
                'verbose_name': 'Race',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driverID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.drivers')),
                ('raceID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.races')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.sessions')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points', models.IntegerField()),
                ('positionsGained', models.IntegerField()),
                ('constructorID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.constructors')),
                ('engineManufacturerID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.enginesmanufacturers')),
                ('raceID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.races')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.sessions')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chassisID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.chassis')),
                ('constructorID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.constructors')),
                ('enginesManufacturerID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.enginesmanufacturers')),
                ('entrantID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.entrants')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.sessions')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('engineID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.engines')),
                ('enginesManufacturerID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.enginesmanufacturers')),
                ('entrantID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.entrants')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.sessions')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('totalFastestLaps', models.IntegerField()),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.sessions')),
                ('tyreManufacturerID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.tyremanufacturers')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='sessions_entrants_tyres_manufacuturers',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('constructorID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.constructors')),
                ('enginesManufacturerID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.enginesmanufacturers')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raceID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.races')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.sessions')),
                ('tyreManufacturersID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='f1_races.tyremanufacturers')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='races_free_pratice4_results',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round', models.IntegerField()),
                ('positionDisplayOrder', models.IntegerField()),
        ...
        migrations.CreateModel(
            name='races_free_pratice3_results',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round', models.IntegerField()),
                ('positionDisplayOrder', models.IntegerField()),
        ...
        migrations.CreateModel(
            name='races_free_pratice2_results',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round', models.IntegerField()),
                ('positionDisplayOrder', models.IntegerField()),
        ...
        migrations.CreateModel(
            name='races_free_pratice1_results',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round', models.IntegerField()),
                ('positionDisplayOrder', models.IntegerField()),
